...
HD_PWD='F:/Digital System Designing using Verilog/System Design Using Verilog/Verilog_files/Gate Levl Modelling/1_AOI4/1_AOI4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aio4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aio4.tcl
