...
HD_PWD='F:/Digital System Designing using Verilog/System Design Using Verilog/Verilog_files/Gate Levl Modelling/2_3bit_squarer/2_3bit_squarer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log squarer_3b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source squarer_3b.tcl
